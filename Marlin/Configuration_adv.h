 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 40    // Seconds          (Was 20 - DAV)
  #define THERMAL_PROTECTION_BED_HYSTERESIS 10 // Degrees Celsius (Was 2 - DAV)
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE 17             // Default feedrate for retracting (mm/s)
